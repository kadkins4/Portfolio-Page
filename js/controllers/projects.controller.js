...
(function () {
  ...
  function projectsService () {
    const projects = [
      { id: 1, name: 'Memory Match', img_url: 'images/memorymatch.png', description: 'My first project at General Assembly, although heavily assisted is one that I am proud of and started the process to creating all that is listed below.  This is a simple game of memory match, using JS/JQuery for the logic and HTML5/CSS3 on the front.  I occasionally go back and add some small additions.', tech: ['CSS3', 'JavaScript', 'JQuery'], git_url: '', live_url: '' },
      ...
      { id: 8, name: 'REY Photographs', img_url: '', description: 'In Progress: A website for a local DC photographer to showcase her work.', tech: ['HTML5', 'CSS3', 'Ruby on Rails', 'AngularJS'], git_url: '', live_url: '' },
