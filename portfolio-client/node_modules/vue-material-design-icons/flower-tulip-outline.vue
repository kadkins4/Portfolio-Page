<template>
  <span class="material-design-icon flower-tulip-outline-icon"
...
<script>
  export default {
    name: "flower-tulip-outline-icon",
    props: {
      title: {
        type: String,
